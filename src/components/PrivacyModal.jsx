          ...
          >
            ...
            <div className="flex items-center gap-4 px-6 py-5 border-b border-[#1e293b] shrink-0">
              ...
              <div className="flex-1 min-w-0">
                <h2 className="font-bold text-lg leading-tight text-white">{t('legal.privacy.title')}</h2>
                <p className="text-xs text-gray-500 mt-0.5"><span className="text-[#F59E0B]">Killer</span> Control · {t('legal.privacy.subtitle')}</p>
              </div>
              <button
                onClick={onClose}
